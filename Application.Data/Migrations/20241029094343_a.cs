    ...
    public partial class a : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Category_Products_ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "Size_ProductDetails",
                columns: table => new
                {
                    Size_ProductDetail_ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SizeID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Size_ProductDetails", x => x.Size_ProductDetail_ID);
                    table.ForeignKey(
                        name: "FK_Size_ProductDetails_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Size_ProductDetails_Sizes_SizeID",
                        column: x => x.SizeID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Color_ProductDetails", x => x.Color_ProductDetailID);
                    table.ForeignKey(
                        name: "FK_Color_ProductDetails_Colors_ColorID",
                        column: x => x.ColorID,
                        principalTable: "Colors",
                        principalColumn: "ColorID");
                    table.ForeignKey(
                        name: "FK_Color_ProductDetails_ProductDetails_ProductDetailID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ColorID");
                    table.ForeignKey(
                        name: "FK_InventoryLogs_ProductDetails_ProductDetailID",
                        column: x => x.ProductDetailID,
                        principalTable: "ProductDetails",
                        principalColumn: "ProductDetailID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventory_ProductDetails", x => x.Inventory_ProductDetailID);
                    table.ForeignKey(
                        name: "FK_Inventory_ProductDetails_InventoryLogs_LogID",
                        column: x => x.LogID,
                        principalTable: "InventoryLogs",
                        principalColumn: "LogID");
                    table.ForeignKey(
                        name: "FK_Inventory_ProductDetails_ProductDetails_ProductDetailsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Color_ProductDetails_ColorID",
                table: "Color_ProductDetails",
                column: "ColorID");

            migrationBuilder.CreateIndex(
                name: "IX_Color_ProductDetails_ProductDetailID",
                table: "Color_ProductDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventory_ProductDetails_LogID",
                table: "Inventory_ProductDetails",
                column: "LogID");

            migrationBuilder.CreateIndex(
                name: "IX_Inventory_ProductDetails_ProductDetailsID",
                table: "Inventory_ProductDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLogs_ProductDetailID",
                table: "InventoryLogs",
                column: "ProductDetailID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Size_ProductDetails_ProductID",
                table: "Size_ProductDetails",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_Size_ProductDetails_SizeID",
                table: "Size_ProductDetails",
                column: "SizeID");
